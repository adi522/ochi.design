...
function Footer() {
    return (
        <>
            <div className='w-full flex justify-between px-14 pb-8'>
                <div className='left w-1/2'>
                    <h1 className='text-[6vw] uppercase tracking-tighter leading-none font-bold'><span className='block'>eye-</span>opening</h1>
                </div>
                <div className='right w-1/2'>
                    <h1 className='text-[6vw] uppercase tracking-tighter leading-none font-bold mb-4'>presentations</h1>
                    <div className='flex flex-col text-[1.1vw] leading-1'>
                        <h1 className='mb-7'>S:</h1>
                        <h1>Instagram</h1>
                        <h1>Behance</h1>
                        <h1>Facebook</h1>
                        <h1>Linkedin</h1>
                    ...
                    <div className='flex justify-between'>
                        <div className='flex flex-col text-[1.1vw] mt-8 leading-1'>
                            <h1 className='mb-7'>L:</h1>
                            <h1>202-1965 W 4th Ave</h1>
                            <h1 className='mb-7'>Vancouver, Canada</h1>
                            <h1>30 Chukarina St</h1>
                            <h1>Lviv, Ukraine</h1>
                        </div>
                        <div className='flex flex-col text-[1.1vw] mt-8 leading-1 mr-10'>
                            <h1 className='mb-7'>M:</h1>
                            <h1>Home</h1>
                            <h1>Services</h1>
                            <h1>Our work</h1>
                            <h1>About us</h1>
                    ...
                    <div className='flex flex-col text-[1.1vw] mt-8 leading-1'>
                        <h1 className='mb-7'>E:</h1>
                        <h1>hello@ochi.design</h1>
                    </div>
                </div>
            </div>

            <div className='w-full flex justify-between px-14 pb-4'>
                <div className='left w-1/2 Logo'>
                ...
                <div className='right w-1/2 flex justify-between'>
                    <div className='flex justify-between text-[1.1vw] leading-1'>
                        <h1 className='mb-7 text-[#6F6F6F]'>&copy; ochi design 2025. Legal Terms</h1>
                    </div>
                    <div>
                        <h1 className='mb-7 text-[#6F6F6F]'>Website by Obys</h1>
